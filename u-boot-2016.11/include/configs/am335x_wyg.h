...
#ifndef __CONFIG_AM335X_WYG_H
#define __CONFIG_AM335X_WYG_H
...
#define CONFIG_SYS_LDSCRIPT		"board/1Sander/am335x/u-boot.lds"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"rootpath=/nfsroot\0" \
	"nfsopts=nolock\0" \
	"ipaddr=192.168.2.200\0" \
	"serverip=192.168.2.100\0" \
	"gatewayip=192.168.2.1\0" \
	...
	"update_MLO="\
		...
		"nand write 0x82000000  0x0 $filesize;\0" \
	"update_all="\
		"run update_MLO;" \
		"run update_uboot;" \
		"run update_kernel;" \
	...
	"update_kernel="\
		...
		"nand write ${loadaddr} NAND.kernel $filesize;\0" \
	"update_rootfs="\
		"tftp ${loadaddr} ubi.img;" \
		"nand erase.part NAND.file-system;" \
		"nand write ${loadaddr} NAND.file-system $filesize; \0" \
	"update_uboot="\
		"tftp ${loadaddr} u-boot.img;" \
		"nand erase.part NAND.u-boot;" \
		"nand write ${loadaddr} NAND.u-boot $filesize; \0" \
	"erase_uboot="\
		...
		"nand erase.part NAND.u-boot-env.backup1; \0" \
	NANDARGS \
	DFUARGS
#endif
